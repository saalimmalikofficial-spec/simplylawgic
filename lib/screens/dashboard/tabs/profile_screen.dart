...
import '../profile/select_name_exam_Screen.dart';
...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  // ============ LOAD (dynamic from API) ============
  Future<void> _loadUserData() async {
    if (!mounted) return;
    setState(() => _isLoading = true);

    try {
      // Analytics API se data fetch karo
      ...
      // fallback: local storage se student le
      try {
        final local = await _storage.getStudent();
        if (mounted) setState(() => _student = local);
      } catch (_) {}
    } finally {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              _ThemeToggleCard(isDark: isDark, onToggle: _toggleTheme),
              const SizedBox(height: 10),
                ...
                items: [
                  _MenuItem(
                    ...
                    onTap: () async {
                      ...
                      if (updated == true) {
                        await _loadUserData();
                        _showUpdateSuccess('✅ Exam updated');
                      }
                    },
                    isDark: isDark,
                  ),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color:
              (isDark ? Colors.white : AppColors.primary).withOpacity(0.15),
              blurRadius: 30,
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontWeight: FontWeight.w600,
                      color:
                      isDark ? Colors.white70 : Colors.orange.shade700,
                    ),
                  ),
                ],
              ),
